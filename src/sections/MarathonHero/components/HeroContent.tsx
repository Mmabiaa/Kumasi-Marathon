  ...
  return (
    <div className="w-full text-center">
      ...
      <div className="max-w-[820px] mx-auto text-center px-1">
        <h1 className="animate-fade-in-up font-display font-bold uppercase text-brand-black tracking-tighter leading-[0.88] mb-6 text-center text-[clamp(3rem,8.5vw,5.2rem)]">
          Kumasi City <br /> Marathon 2026
        </h1>
        <p className="animate-fade-in-up-delay my-5 text-center text-[18px] md:text-[19px] font-normal leading-[1.5] font-founders_grotesk text-brand-black max-w-[560px] mx-auto">
        ...
        <div className="animate-fade-in-up-delay-2 flex flex-row flex-wrap items-center justify-center gap-3 md:gap-4 mt-8">
          <a
            href="#register"
