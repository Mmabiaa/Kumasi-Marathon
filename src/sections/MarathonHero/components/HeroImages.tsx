...
export const HeroImages = (props: HeroImagesProps) => {
  return (
    ...
    >
      <div
        className={`relative aspect-[3/4] bg-brand-blue box-border caret-transparent outline-[3px] rounded-[20px] w-full after:accent-auto after:bg-center after:bg-no-repeat after:bg-contain after:box-border after:caret-transparent after:text-brand-blue after:block after:absolute after:outline-[3px] after:pointer-events-auto after:border-separate ${props.imageWrapperVariant}`}
      >
        <img
          src={props.imageSrc}
          alt={props.imageAlt}
          className="absolute inset-0 box-border caret-transparent h-full max-w-full object-cover outline-[3px] align-baseline w-full border-brand-black rounded-[20px] border-2 border-solid"
        />
        <div
