    ...
    <section className="bg-white px-4 py-16 md:px-12 md:py-24">
      <div className="max-w-[1584px] mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="font-founders_grotesk text-emerald-900 text-lg max-w-[560px] mx-auto opacity-80">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4">
          {sponsorSlots.map((label) => (
            <div
              key={label}
              className="border-2 border-dashed border-emerald-300 rounded-[16px] h-24 flex flex-col items-center justify-center gap-2 text-emerald-400 hover:border-emerald-500 hover:text-emerald-600 transition-colors"
            >
              <svg
                width="20"
                height="20"
              ...
              <span className="font-obviously_narrow font-semibold uppercase text-xs text-emerald-900 tracking-[0.3px] text-center px-2">
                {label}
              </span>
            </div>
          ))}
        ...
        <p className="text-center mt-8 font-founders_grotesk text-sm text-emerald-700">
